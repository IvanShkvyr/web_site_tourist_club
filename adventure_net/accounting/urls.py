...
urlpatterns = [
    ...
    path("chenge_club_treasury/<int:treasury_id>/", views.chenge_club_treasury, name="chenge_club_treasury"),
    ...
    path("operation_category/chenge_opr_category/<int:operation_category_id>/", views.chenge_operation_category, name="chenge_operation_category"),
    ...
    path("operation_type/chenge_operation_type/<int:operation_type_id>/", views.chenge_operation_type, name="chenge_operation_type"),
